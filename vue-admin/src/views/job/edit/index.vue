  ...
  <div class="contain">
    <el-form ref="form" :rules="rules" :model="form" label-width="120px">
      <el-form-item label="job name" prop="jobName">
        <el-input v-model="form.jobName" clearable maxlength="20" minlength="2" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="job group" prop="jobGroup">
        <el-input v-model="form.jobGroup" clearable maxlength="15" minlength="2" :disabled="true"></el-input>
      </el-form-item>
      ...
      <el-form-item>
        ...
        <el-button class="fright" type="primary" @click="submitForm('form')">修改</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
<script>
  import { add,getJob } from '@/api/job'
  ...
  export default {
    ...
    methods: {
      getParams () {
        // 取到路由带过来的参数
        this.form.jobName = this.$route.query.jobs
        console.log(this.$route.query.jobs)
        this.getJobByName()
      },
      getJobByName(){
