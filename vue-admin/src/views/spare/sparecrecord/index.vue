...
<template>
  <el-container>
    <el-header>
      <el-row :gutter="10">
        <el-col :span="4">
          <el-input  placeholder="请输入shareId" maxlength="5" minlength="1" clearable v-model="page.search1"></el-input>
        </el-col>
        <el-col :span="4">
    ...
    <el-main >
      <el-table highlight-current-row border :data="tabledata"  empty-text="暂无数据" stripe height="400px" @current-change="handleCurrentChange">
        ...
        <el-table-column  prop="logUserName" label="用户名" sortable width="100px" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="share.shareCoin" label="奖励积分" width="100px"  show-overflow-tooltip></el-table-column>
...
import { list,approve,approveFail} from '@/api/cspare'
