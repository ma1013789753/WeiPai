...
<template>
  <el-container>
    <el-header>
      <el-row :gutter="10">
        <el-col :span="4">
          <el-input  placeholder="请输入备品名称" maxlength="5" minlength="1" clearable v-model="page.search1"></el-input>
        </el-col>
        <el-col :span="1">
    ...
    <el-main >
      <el-table highlight-current-row border :data="tabledata"  empty-text="暂无数据" stripe height="380px" @current-change="handleCurrentChange">
        ...
        <el-table-column  prop="name" label="备品名称" sortable></el-table-column>
        <el-table-column prop="code" label="备品编号" sortable ></el-table-column>
        ...
        <el-table-column prop="number" label="在库数量" sortable ></el-table-column>
        <el-table-column  prop="warnLine" label="警报线" sortable ></el-table-column>
        <el-table-column  prop="user" label="负责人"  sortable ></el-table-column>
...
<script>
import { list,del} from '@/api/spare'
