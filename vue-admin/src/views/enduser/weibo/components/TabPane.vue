    ...
    <el-dialog title="账号详情" :visible.sync="dialogFormVisible">
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="账号名称" prop="accountName">
          <el-input disabled v-model="form.accountName"></el-input>
        </el-form-item>
        </el-col>
        ...
        <el-col :span="8">
        <el-form-item label="微博数" prop="statusesCount">
          <el-input v-model="form.statusesCount" disabled></el-input>
        </el-form-item>
        </el-col>
...
export default {
  ...
  methods: {
    ...
    getList(page) {
      ...
      getAccounts(page,0,this.listQuery.type).then(res => {
