...
public class IndexController {
    ...
    public ApiResult index() {
        ...
        adlist.forEach(stringObjectMap -> {
            stringObjectMap.put("ad_img",stringObjectMap.get("ad_img").toString().replace("./", ShareUtil.URL));
        });
        //money
        ...
        monList.forEach(stringObjectMap -> {
            if(StringUtils.isEmpty(stringObjectMap.get("background_image").toString())){
                stringObjectMap.put("background_image", ShareUtil.URL+"Upload/money_push.jpg");
            }
        ...
        List<Map<String,Object>> tuiList = ShareUtil.toLowBeanList(recPage.getRecords());
        ...
        cmsList.forEach(stringObjectMap -> {
            ...
            stringObjectMap.put("cms_image",stringObjectMap.get("cms_image").toString().replace("./", ShareUtil.URL));
        });
...
//        List<Map<String,Object>> cmsList = ShareUtil.toLowBeanList(cmsdata);
//        cmsList.forEach(stringObjectMap -> {
//            stringObjectMap.put("add_time_text",ShareUtil.getTaxt(stringObjectMap.get("add_time").toString()));
//            stringObjectMap.put("cms_image",stringObjectMap.get("cms_image").toString().replace("./", ShareUtil.URL));
//        });
