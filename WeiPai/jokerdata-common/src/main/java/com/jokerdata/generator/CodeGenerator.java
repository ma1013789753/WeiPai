...
//        gc.setControllerName("%sController");
        ...
        dsc.setUrl("jdbc:mysql://39.105.97.119:3306/share?useUnicode=true&useSSL=false&characterEncoding=utf8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("8cfd5ab45b");
...
//        packageConfig.setController("controller");
        ...
        strategy.setInclude(new String[]{"g_shop","g_shop_his"});
